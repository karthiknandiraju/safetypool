#!/usr/bin/env python3
"""Run one or more MetaDrive policies for a seed and compare with baselines.
...
Run one policy for seed 11 and compare it with existing seed-11 baselines:
    ...
    python run_seed_policy_comparison.py --seed 11 \
      --policy-files policies/metadrivech67.py --device cuda
...
Compare several policies together:
    ...
    python run_seed_policy_comparison.py --seed 11 \
      --policy-files policies/policy_a.py policies/policy_b.py --device cuda

Reuse existing policy outputs without retraining:

    python run_seed_policy_comparison.py --seed 11 \
      --policy-files policies/metadrivech67.py --skip-policy-training
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run MetaDrive policies for any seed and generate collision-only "
