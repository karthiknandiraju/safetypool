...
``canonical_baselines/seed_N`` beside this script.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Seed used to derive canonical_baselines/seed_<seed> when "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Otherwise use canonical_baselines/seed_<seed>."
        ),
    )
    parser.add_argument(
    ...
    if args.baseline_root is None:
        ...
        args.baseline_root = (
            project / "canonical_baselines" / f"seed_{args.seed}"
        ).resolve()
